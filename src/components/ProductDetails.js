...
const ProductDetails = ({prd}) => {
    ...
    async function getProductDetail(){
        const prdData = await axios.get(`https://fakestoreapi.com/products/${prd}`);
        ...
        <div id="product-detail">
            {
                prdDetail && (
                        <div key={prdDetail.id} id="detail">
                            <div>
                                <div>
                                    <img src={prdDetail.image}
                                        alt={prdDetail.title} />
                                </div>
                                <div>
                                    <button><svg className="_1KOMV2" width="16" height="16" viewBox="0 0 16 15"
